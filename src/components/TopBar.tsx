                ...
                <div className="flex items-center gap-3 pointer-events-auto">
                    ...
                    {lastAutoSaveTime && !hasUnsavedChanges && (
                        <div className={`text-[10px] font-medium px-2 py-1 rounded border animate-in fade-in duration-500 ${canvasTheme === 'dark'
                            ...
                            {labels.autoSavedPrefix} {new Date(lastAutoSaveTime).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                        </div>
                    )}
                    <button
                        onClick={() => onSave()}
                    ...
                    <button
                        ...
                        title={canvasTheme === 'dark' ? labels.switchToDayMode : labels.switchToNightMode}
                    >
                        {canvasTheme === 'dark' ? (
            ...
            {showNewConfirm && (
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[100]">
                    <div className="bg-[#1a1a1a] border border-neutral-700 rounded-2xl p-6 w-[400px] shadow-2xl">
                        <h3 className="text-lg font-semibold text-white mb-2">{labels.unsavedChangesTitle}</h3>
